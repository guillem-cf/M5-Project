...
from models.models import SiameseNet
...
if finetuned:
    ...
    model.load_state_dict(torch.load("Results/Task_b/Task_b_siamese.pth"))
else:
...
plot_retrieval(
    test_images, train_images, y_true_test, y_true_train, neigh_ind, neigh_dist, output_dir="Results/Task_b", p=""
)
plot_retrieval(
    test_images, train_images, y_true_test, y_true_train, neigh_ind, neigh_dist, output_dir="Results/Task_b", p="BEST"
)
plot_retrieval(
    test_images, train_images, y_true_test, y_true_train, neigh_ind, neigh_dist, output_dir="Results/Task_b", p="WORST"
)

tsne_features(image_features_train, y_true_train, "train", labels=test_dataset.classes, output_dir="Results/Task_b")
tsne_features(image_features_test, y_true_test, "test", labels=test_dataset.classes, output_dir="Results/Task_b")