...
train_dataset = CocoDatasetWeek5(os.path.join(dataset_path, "instances_train2014.json"), train_path, transform=transform_train)
train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True, num_workers=4, pin_memory=True)

val_dataset = CocoDatasetWeek5(os.path.join(dataset_path, "instances_val2014.json"), val_path, transform=transform_val)
